  ...
  return (
    <div className="min-h-screen bg-blue-50 text-black font-sans selection:bg-blue-200">
      ...
      <nav className="flex justify-between items-center px-10 py-8 fixed w-full z-10">
        ...
        <div className="text-sm font-bold border-b-2 border-black cursor-pointer pb-0.5 hover:text-blue-600 transition">
          Book A Call ↗
        </div>
      </nav>
        ...
        <div className="container mx-auto px-10 flex flex-col lg:flex-row items-center justify-between">
          ...
          <div className="w-full lg:w-1/2 flex justify-end relative">
            <div className="grayscale contrast-125 rounded-2xl overflow-hidden shadow-2xl shadow-blue-200">
              {/* Using a standard img tag is fine for now, but ESLint might complain. 
                  Adding 'alt' attribute fixes most red lines here. */}
              <img 
